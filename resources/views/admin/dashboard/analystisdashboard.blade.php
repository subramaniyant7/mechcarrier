...
@section('title','Analystis Dashboard')
@section('head')
    <head>
        <link href="{{ URL::asset(ADMIN . '/plugins/src/apex/apexcharts.css') }}" rel="stylesheet" type="text/css">
        <link href="{{ URL::asset(ADMIN . '/assets/css/light/dashboard/dash_1.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ URL::asset(ADMIN . '/assets/css/dark/dashboard/dash_1.css') }}" rel="stylesheet" type="text/css" />
    </head>
@stop
                ...
                <div class="widget-content">
                    <div class="account-box">
                        ...
                        <div class="acc-action">
                            <div class="">
                                <a href="javascript:void(0);" class="btn-wallet"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <div class="meta-info">
                        ...
                        <div class="avatar--group">
                            ...
                            <div class="avatar translateY-axis">
                                <img alt="avatar" src="{{ URL::asset(ADMIN . '/assets/img/profile-8.jpeg') }}" />
                            </div>
                            <div class="avatar translateY-axis">
                                <img alt="avatar" src="{{ URL::asset(ADMIN . '/assets/img/profile-12.jpeg') }}" />
                            </div>
                            <div class="avatar translateY-axis">
                                <img alt="avatar" src="{{ URL::asset(ADMIN . '/assets/img/profile-19.jpeg') }}" />
                            </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
            <div class="widget widget-card-one">
                <div class="widget-content">
                    ...
                    <div class="media">
                        <div class="w-img">
                            <img src="{{ URL::asset(ADMIN . '/assets/img/profile-19.jpeg') }}" alt="avatar">
                        </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
            <div class="widget widget-card-two">
                <div class="widget-content">
                    ...
                    <div class="media">
                        <div class="w-img">
                            <img src="{{ URL::asset(ADMIN . '/assets/img/g-8.png') }}" alt="avatar">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="card-bottom-section">
                        ...
                        <div class="img-group">
                            <img src="{{ URL::asset(ADMIN . '/assets/img/profile-19.jpeg') }}" alt="avatar">
                            <img src="{{ URL::asset(ADMIN . '/assets/img/profile-6.jpeg') }}" alt="avatar">
                            <img src="{{ URL::asset(ADMIN . '/assets/img/profile-8.jpeg') }}" alt="avatar">
                            <img src="{{ URL::asset(ADMIN . '/assets/img/profile-3.jpeg') }}" alt="avatar">
                        </div>
...
@section('footer')
    ...
    <script src="{{ URL::asset(ADMIN . '/assets/js/dashboard/dash_1.js') }}"></script>
@stop
