                    ...
                    <div class="mt-container-ra mx-auto">
                        <div class="timeline-line">
                            ...
                            <div class="item-timeline  timeline-dark">
                                ...
                                <div class="t-text">
                                    <p>Collect documents from <a href="javascript:void(0);">Sara</a>
                                    </p>
                                    <span class="badge">Completed</span>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
            ...
            <div class="widget widget-wallet-one">
                ...
                <div class="wallet-info text-center mb-3">
                    ...
                    <a href="#" class="wallet-text"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" class="feather feather-trending-up me-2">
