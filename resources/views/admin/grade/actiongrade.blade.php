...
@section('content')
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            ...
            <a href="{{ route('grade') }}" class="btn btn-primary btn-rounded mb-2 me-4"><i
        ...
        <div class="col-lg-12 col-12  layout-spacing layout-top-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <form action="{{ route('savegrade') }}" method="POST" autocomplete="off">
                        @csrf
                        ...
                        <div class="form-group row  mb-4">
                            <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label-sm">Grade Name<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-control" name="education_grade_name" placeholder="Grade Name"
                                    required value="{{ isset($data) ? $data[0]->education_grade_name : old('education_grade_name') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-10">
                                ...
                                <a href="{{ route('grade') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </div>
                        <input type="hidden" name="education_grade_id"
                            value="{{ isset($data) ? encryption($data[0]->education_grade_id) : '' }}">
                    </form>
                </div>
            </div>
        </div>
