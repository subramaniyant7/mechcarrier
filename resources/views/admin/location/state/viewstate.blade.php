...
@section('content')
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            ...
            <a href="{{ route('managestate') }}" class="btn btn-primary btn-rounded mb-2 me-4"><i
                    class="fa-solid fa-plus"></i> State</a>
        </nav>
    </div>
    <!-- /BREADCRUMB -->
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-8">
                <table id="zero-config" class="table table-striped dt-table-hover" style="width:100%">
                    ...
                    <tbody>
                        @forelse($state as $k => $state)
                            @php
                                $class = $state->status == 1 ? 'badge-light-success' : '';
                                $countryData = App\Http\Controllers\Admin\Helper\CommonHelperController::getCountry($state->country_id);
                                $countryName = '';
                            ...
                            <tr>
                                ...
                                <td> <span
                                        class="{{ statusClass()[$state->status - 1] }}">{{ statustype()[$state->status - 1] }}</span>
                                </td>
                                <td>
                                    <div class="action-btns">
                                        <a href="{{ route('actionstate', ['option' => 'edit', 'id' => encryption($state->state_id)]) }}"
                                        ...
                                        <a href="{{ route('actionstate', ['option' => 'delete', 'id' => encryption($state->state_id)]) }}"
