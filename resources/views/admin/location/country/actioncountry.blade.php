...
@section('content')
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            ...
            <a href="{{ route('country') }}" class="btn btn-primary btn-rounded mb-2 me-4"><i
        ...
        <div class="col-lg-12 col-12  layout-spacing layout-top-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <form action="{{ route('savecountry') }}" method="POST" autocomplete="off">
                        @csrf
                        <div class="form-group row  mb-4">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-control" name="country_name"
                                    ...
                                    value="{{ isset($data) ? $data[0]->country_name : old('country_name') }}">
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="country_id"
                            value="{{ isset($data) ? encryption($data[0]->country_id) : '' }}">
                    </form>
                </div>
            </div>
        </div>
