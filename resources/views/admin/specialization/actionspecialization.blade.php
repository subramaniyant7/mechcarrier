...
@section('title', 'Manage Specialization')
...
@section('content')
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            ...
            <a href="{{ route('specialization') }}" class="btn btn-primary btn-rounded mb-2 me-4"><i
        ...
        <div class="col-lg-12 col-12  layout-spacing layout-top-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <form action="{{ route('savespecialization') }}" method="POST" autocomplete="off">
                        @csrf
                        ...
                        <div class="form-group row  mb-4">
                            <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label-sm">Specialization Name<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-control" name="education_specialization_name" placeholder="Specialization Name"
                                    required value="{{ isset($data) ? $data[0]->education_specialization_name : old('education_specialization_name') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-10">
                                ...
                                <a href="{{ route('specialization') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </div>
                        <input type="hidden" name="education_specialization_id"
                            value="{{ isset($data) ? encryption($data[0]->education_specialization_id) : '' }}">
                    </form>
                </div>
            </div>
        </div>
