    ...
    <div class="col-md-2 form-checkbox">
        ...
        <div class="d-flex">
            <div class="form-check">
                ...
                <input class="form-check-input enable user_language_read" data-id="user_language_read_value" name="user_language_read[]" type="checkbox"
                    value="1">
            </div>
        </div>
    </div>
    <div class="col-md-2 form-checkbox">
        ...
        <div class="d-flex">
            <div class="form-check">
                ...
                <input class="form-check-input enable user_language_write" data-id="user_language_write_value" name="user_language_write[]" type="checkbox"
                    value="1">
            </div>
        </div>
    </div>
    <div class="col-md-2 form-checkbox">
        ...
        <div class="d-flex">
            <div class="form-check">
                ...
                <input class="form-check-input enable user_language_speak" data-id="user_language_speak_value" name="user_language_speak[]" type="checkbox"
                    value="1">
            </div>
        </div>
    </div>
